...
if menu == "Introduction & Objective":
    ...
    with tab1:
        ...
        st.image("images/categorical_distribution.png", caption="Figure 4. Number of Products in Each Category")
        st.markdown("""
        ...
        st.image("images/product_designation_length.png", caption="Figure 5. Distribution of Product Designation Lengths")
        st.markdown("""
        ...
        st.image("images/product_description_length.png", caption="Figure 6. Distribution of Product Description Lengths")
        st.markdown("""
        ...
        st.image("images/products_with_and_without_description.png", caption="Figure 7. Proportion of Products with and without Descriptions")
        st.markdown("""
        ...
        st.image("images/wordcloud_general.png", caption="Figure 8. Frequent Words in Product Titles/Descriptions")
        st.markdown("""
    ...
    with tab2:
        ...
        st.image("images/blank_images.png", caption="Figure 9. Number of Blank Images Across Categories")
        st.markdown("""
        ...
        st.image("images/image_sharpness.png", caption="Figure 10. Proportion of Images by Sharpness Category")
        st.markdown("""
        - **91%** of images are sharp and of high quality.  
        - A small proportion (1.51%) is blurry.  
        """)
        
        st.image("images/image_sharpness_distribution.png", caption="Figure 11. Distribution of Image Sharpness Across Categories")
        st.markdown("""
        ...
        st.image("images/images_with_text.png", caption="Figure 12. Images with Text Across Categories")
        st.markdown("""
    ...
    with tab2:
        ...
        st.markdown(""" For multimodal fusion model (text and image classification model) demo please refer the github repository 
                    (Link: https://github.com/Syed-Suhel/Rakuten-E-commerce-multimodal-Text-and-Image-classification.git).\n The repository contains streamlit file under src 
